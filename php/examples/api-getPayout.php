...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetPayoutInput};
...
$input = new ApiGetPayoutInput((array) json_decode('{"payout_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getPayout($input, new RequestOptions(maxAttempts: 1));
