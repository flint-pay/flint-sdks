...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeSubscriptionsInput};
...
$input = new ApiListMeSubscriptionsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeSubscriptions($input, new RequestOptions(maxAttempts: 1));
