...
use Flint\{Client, ClientOptions, RequestOptions, ApiListAPIKeysInput};
...
$input = new ApiListAPIKeysInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listAPIKeys($input, new RequestOptions(maxAttempts: 1));
