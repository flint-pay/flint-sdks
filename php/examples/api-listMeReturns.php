...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeReturnsInput};
...
$input = new ApiListMeReturnsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeReturns($input, new RequestOptions(maxAttempts: 1));
