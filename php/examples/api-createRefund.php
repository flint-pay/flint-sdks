...
use Flint\{Client, ClientOptions, RequestOptions, ApiCreateRefundInput};
...
$input = new ApiCreateRefundInput((array) json_decode('{"body":{"order_id":"example"}}', false, 512, JSON_THROW_ON_ERROR));
