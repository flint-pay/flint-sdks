...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetReportInput};
...
$input = new ApiGetReportInput((array) json_decode('{"report_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getReport($input, new RequestOptions(maxAttempts: 1));
