...
use Flint\{Client, ClientOptions, RequestOptions, ApiListPackagesInput};
...
$input = new ApiListPackagesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listPackages($input, new RequestOptions(maxAttempts: 1));
