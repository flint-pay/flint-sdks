...
use Flint\{Client, ClientOptions, RequestOptions, ApiListReviewsInput};
...
$input = new ApiListReviewsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listReviews($input, new RequestOptions(maxAttempts: 1));
