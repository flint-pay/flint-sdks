...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeCreditNotesInput};
...
$input = new ApiListMeCreditNotesInput((array) json_decode('{"invoice_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeCreditNotes($input, new RequestOptions(maxAttempts: 1));
