...
$input = new ApiRetryReturnDispositionInput((array) json_decode('{"return_disposition_id":"example","body":{"reason":"dependency_recovered"}}', false, 512, JSON_THROW_ON_ERROR));
