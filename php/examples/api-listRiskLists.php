...
use Flint\{Client, ClientOptions, RequestOptions, ApiListRiskListsInput};
...
$input = new ApiListRiskListsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listRiskLists($input, new RequestOptions(maxAttempts: 1));
