...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeInvoicesInput};
...
$input = new ApiListMeInvoicesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeInvoices($input, new RequestOptions(maxAttempts: 1));
