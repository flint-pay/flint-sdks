...
use Flint\{Client, ClientOptions, RequestOptions, ApiListCapabilitiesInput};
...
$input = new ApiListCapabilitiesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listCapabilities($input, new RequestOptions(maxAttempts: 1));
