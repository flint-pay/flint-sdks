...
$input = new ApiCreateDeliveryPreviewInput((array) json_decode('{"body":{"currency":"USD","delivery_method_ids":[],"line_items":[{"variant_id":"example"}]}}', false, 512, JSON_THROW_ON_ERROR));
