...
$input = new ApiCreateInventoryTransferInput((array) json_decode('{"Idempotency-Key":"example","body":{"destination_location_id":"example","lines":[{"inventory_item_id":"example","requested_quantity":"1"}],"origin_location_id":"example"}}', false, 512, JSON_THROW_ON_ERROR));
