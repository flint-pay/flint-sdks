...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetMeInput};
...
$input = new ApiGetMeInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getMe($input, new RequestOptions(maxAttempts: 1));
