...
$input = new ApiTransferOrganizationOwnershipInput((array) json_decode('{"organization_id":"example","body":{"new_owner_user_id":"example"}}', false, 512, JSON_THROW_ON_ERROR));
