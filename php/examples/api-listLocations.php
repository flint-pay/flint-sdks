...
use Flint\{Client, ClientOptions, RequestOptions, ApiListLocationsInput};
...
$input = new ApiListLocationsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listLocations($input, new RequestOptions(maxAttempts: 1));
