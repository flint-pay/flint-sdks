...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMePackagesInput};
...
$input = new ApiListMePackagesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMePackages($input, new RequestOptions(maxAttempts: 1));
