...
$input = new ApiGetCheckoutSessionDeliverySelectionHistoryInput((array) json_decode('{"checkout_session_id":"example","delivery_selection_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
