...
$input = new ApiCreateMeReturnPreviewInput((array) json_decode('{"body":{"mode":"eligibility","eligibility":{"order_id":"example","selection":{"selection_type":"all_remaining_fulfilled"}}}}', false, 512, JSON_THROW_ON_ERROR));
