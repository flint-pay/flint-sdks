...
use Flint\{Client, ClientOptions, RequestOptions, ApiListReportsInput};
...
$input = new ApiListReportsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listReports($input, new RequestOptions(maxAttempts: 1));
