...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetReviewInput};
...
$input = new ApiGetReviewInput((array) json_decode('{"review_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getReview($input, new RequestOptions(maxAttempts: 1));
