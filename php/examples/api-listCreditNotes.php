...
use Flint\{Client, ClientOptions, RequestOptions, ApiListCreditNotesInput};
...
$input = new ApiListCreditNotesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listCreditNotes($input, new RequestOptions(maxAttempts: 1));
