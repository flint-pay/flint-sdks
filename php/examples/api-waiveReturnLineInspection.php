...
$input = new ApiWaiveReturnLineInspectionInput((array) json_decode('{"return_id":"example","return_line_item_id":"example","body":{"reason":"policy_override"}}', false, 512, JSON_THROW_ON_ERROR));
