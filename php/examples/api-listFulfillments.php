...
use Flint\{Client, ClientOptions, RequestOptions, ApiListFulfillmentsInput};
...
$input = new ApiListFulfillmentsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listFulfillments($input, new RequestOptions(maxAttempts: 1));
