...
$input = new ApiDecideReturnInput((array) json_decode('{"return_id":"example","body":{"line_items":[{"approved_quantity":"0","decision_basis":"policy_evaluation","return_line_item_id":"example"}]}}', false, 512, JSON_THROW_ON_ERROR));
