...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeShipmentsInput};
...
$input = new ApiListMeShipmentsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeShipments($input, new RequestOptions(maxAttempts: 1));
