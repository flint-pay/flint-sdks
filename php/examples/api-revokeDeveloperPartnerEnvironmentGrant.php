...
$input = new ApiRevokeDeveloperPartnerEnvironmentGrantInput((array) json_decode('{"partner_app_id":"example","partner_app_install_id":"example","environment_grant_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
