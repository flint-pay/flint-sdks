...
use Flint\{Client, ClientOptions, RequestOptions, ApiListDevicesInput};
...
$input = new ApiListDevicesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listDevices($input, new RequestOptions(maxAttempts: 1));
