...
$input = new ApiCreateMeAddressInput((array) json_decode('{"body":{"address":{"city":"example","country":"US","line1":"example","postal_code":"example","state":"example"},"recipient_name":"example"}}', false, 512, JSON_THROW_ON_ERROR));
