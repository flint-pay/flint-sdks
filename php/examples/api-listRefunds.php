...
use Flint\{Client, ClientOptions, RequestOptions, ApiListRefundsInput};
...
$input = new ApiListRefundsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listRefunds($input, new RequestOptions(maxAttempts: 1));
