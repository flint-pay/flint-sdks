...
use Flint\{Client, ClientOptions, RequestOptions, ApiListCategoriesInput};
...
$input = new ApiListCategoriesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listCategories($input, new RequestOptions(maxAttempts: 1));
