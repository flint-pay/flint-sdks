...
$input = new ApiCreateInventoryCountInput((array) json_decode('{"Idempotency-Key":"example","body":{"inventory_item_ids":["example"],"location_id":"example"}}', false, 512, JSON_THROW_ON_ERROR));
