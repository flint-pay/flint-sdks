...
use Flint\{Client, ClientOptions, RequestOptions, ApiListOrdersInput};
...
$input = new ApiListOrdersInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listOrders($input, new RequestOptions(maxAttempts: 1));
