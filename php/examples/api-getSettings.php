...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetSettingsInput};
...
$input = new ApiGetSettingsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getSettings($input, new RequestOptions(maxAttempts: 1));
