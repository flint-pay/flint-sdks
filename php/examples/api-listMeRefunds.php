...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeRefundsInput};
...
$input = new ApiListMeRefundsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeRefunds($input, new RequestOptions(maxAttempts: 1));
