...
$input = new ApiRecordManualInvoicePaymentInput((array) json_decode('{"invoice_id":"example","body":{"amount_money":{"amount":"0","currency":"USD"}}}', false, 512, JSON_THROW_ON_ERROR));
