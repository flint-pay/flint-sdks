...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetDeviceInput};
...
$input = new ApiGetDeviceInput((array) json_decode('{"device_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getDevice($input, new RequestOptions(maxAttempts: 1));
