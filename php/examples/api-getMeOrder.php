...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetMeOrderInput};
...
$input = new ApiGetMeOrderInput((array) json_decode('{"order_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getMeOrder($input, new RequestOptions(maxAttempts: 1));
