...
use Flint\{Client, ClientOptions, RequestOptions, ApiListBundlesInput};
...
$input = new ApiListBundlesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listBundles($input, new RequestOptions(maxAttempts: 1));
