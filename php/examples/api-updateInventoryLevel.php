...
$input = new ApiUpdateInventoryLevelInput((array) json_decode('{"Idempotency-Key":"example","inventory_level_id":"example","body":{"safety_stock_quantity":"0"}}', false, 512, JSON_THROW_ON_ERROR));
