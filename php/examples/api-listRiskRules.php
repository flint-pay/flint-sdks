...
use Flint\{Client, ClientOptions, RequestOptions, ApiListRiskRulesInput};
...
$input = new ApiListRiskRulesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listRiskRules($input, new RequestOptions(maxAttempts: 1));
