...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetMeAddressInput};
...
$input = new ApiGetMeAddressInput((array) json_decode('{"customer_address_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getMeAddress($input, new RequestOptions(maxAttempts: 1));
