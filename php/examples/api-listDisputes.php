...
use Flint\{Client, ClientOptions, RequestOptions, ApiListDisputesInput};
...
$input = new ApiListDisputesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listDisputes($input, new RequestOptions(maxAttempts: 1));
