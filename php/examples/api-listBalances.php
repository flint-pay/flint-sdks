...
use Flint\{Client, ClientOptions, RequestOptions, ApiListBalancesInput};
...
$input = new ApiListBalancesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listBalances($input, new RequestOptions(maxAttempts: 1));
