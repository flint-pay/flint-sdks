...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeAddressesInput};
...
$input = new ApiListMeAddressesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeAddresses($input, new RequestOptions(maxAttempts: 1));
