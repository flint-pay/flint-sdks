...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetOrderInput};
...
$input = new ApiGetOrderInput((array) json_decode('{"order_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getOrder($input, new RequestOptions(maxAttempts: 1));
