...
use Flint\{Client, ClientOptions, RequestOptions, ApiUpdateSettingsInput};
...
$input = new ApiUpdateSettingsInput((array) json_decode('{"body":{}}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->updateSettings($input, new RequestOptions(maxAttempts: 1));
