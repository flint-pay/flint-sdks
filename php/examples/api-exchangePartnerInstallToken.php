...
$input = new ApiExchangePartnerInstallTokenInput((array) json_decode('{"body":{"client_id":"example","client_secret":"example","grant_type":"example"}}', false, 512, JSON_THROW_ON_ERROR));
