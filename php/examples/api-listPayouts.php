...
use Flint\{Client, ClientOptions, RequestOptions, ApiListPayoutsInput};
...
$input = new ApiListPayoutsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listPayouts($input, new RequestOptions(maxAttempts: 1));
