...
use Flint\{Client, ClientOptions, RequestOptions, ApiListShipmentsInput};
...
$input = new ApiListShipmentsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listShipments($input, new RequestOptions(maxAttempts: 1));
