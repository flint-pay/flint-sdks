...
use Flint\{Client, ClientOptions, RequestOptions, ApiListPromotionsInput};
...
$input = new ApiListPromotionsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listPromotions($input, new RequestOptions(maxAttempts: 1));
