...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetPaymentIntentInput};
...
$input = new ApiGetPaymentIntentInput((array) json_decode('{"payment_intent_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
