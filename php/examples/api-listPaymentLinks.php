...
use Flint\{Client, ClientOptions, RequestOptions, ApiListPaymentLinksInput};
...
$input = new ApiListPaymentLinksInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listPaymentLinks($input, new RequestOptions(maxAttempts: 1));
