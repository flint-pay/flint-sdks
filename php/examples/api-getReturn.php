...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetReturnInput};
...
$input = new ApiGetReturnInput((array) json_decode('{"return_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getReturn($input, new RequestOptions(maxAttempts: 1));
