...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMeFulfillmentsInput};
...
$input = new ApiListMeFulfillmentsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMeFulfillments($input, new RequestOptions(maxAttempts: 1));
