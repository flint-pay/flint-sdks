...
use Flint\{Client, ClientOptions, RequestOptions, ApiListMePaymentMethodsInput};
...
$input = new ApiListMePaymentMethodsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listMePaymentMethods($input, new RequestOptions(maxAttempts: 1));
