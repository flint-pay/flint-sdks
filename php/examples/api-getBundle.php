...
use Flint\{Client, ClientOptions, RequestOptions, ApiGetBundleInput};
...
$input = new ApiGetBundleInput((array) json_decode('{"bundle_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->getBundle($input, new RequestOptions(maxAttempts: 1));
