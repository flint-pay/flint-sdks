...
use Flint\{Client, ClientOptions, RequestOptions, ApiListProductsInput};
...
$input = new ApiListProductsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listProducts($input, new RequestOptions(maxAttempts: 1));
