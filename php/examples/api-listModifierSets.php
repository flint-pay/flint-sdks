...
use Flint\{Client, ClientOptions, RequestOptions, ApiListModifierSetsInput};
...
$input = new ApiListModifierSetsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listModifierSets($input, new RequestOptions(maxAttempts: 1));
