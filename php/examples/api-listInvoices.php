...
use Flint\{Client, ClientOptions, RequestOptions, ApiListInvoicesInput};
...
$input = new ApiListInvoicesInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listInvoices($input, new RequestOptions(maxAttempts: 1));
