...
$input = new ApiCreateReturnReceiptInput((array) json_decode('{"return_id":"example","body":{"line_items":[{"quantity":"100","return_line_item_id":"example"}],"received_at":"2026-01-01T00:00:00Z","receiving_location_id":"example"}}', false, 512, JSON_THROW_ON_ERROR));
