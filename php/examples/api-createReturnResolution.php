...
$input = new ApiCreateReturnResolutionInput((array) json_decode('{"body":{"line_items":[{"quantity":"1","return_line_item_id":"rtli_example"}],"resolution_type":"refund"},"return_id":"example"}', false, 512, JSON_THROW_ON_ERROR));
