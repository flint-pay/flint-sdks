...
use Flint\{Client, ClientOptions, RequestOptions, ApiListReturnsInput};
...
$input = new ApiListReturnsInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listReturns($input, new RequestOptions(maxAttempts: 1));
