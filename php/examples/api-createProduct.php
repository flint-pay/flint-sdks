...
$input = new ApiCreateProductInput((array) json_decode('{"body":{"name":"example","product_type":"physical","default_variant":{"unit_price_money":{"amount":"0","currency":"USD"}}}}', false, 512, JSON_THROW_ON_ERROR));
