...
use Flint\{Client, ClientOptions, RequestOptions, ApiListCustomersInput};
...
$input = new ApiListCustomersInput((array) json_decode('{}', false, 512, JSON_THROW_ON_ERROR));
$result = $client->api->listCustomers($input, new RequestOptions(maxAttempts: 1));
